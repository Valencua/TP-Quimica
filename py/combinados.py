...
def get_masses(reaction):
    ...
    for x in listaCompuestos:
        if x in reactivos: 
            if reactivos[x]["mol"] == None: reactivos[x]["mol"] = listasa[listaCompuestos.index(x)]['moles']
            if reactivos[x]["gr"] == None: reactivos[x]["gr"] = listasa[listaCompuestos.index(x)]['grams']
        elif x in productos: 
            if productos[x]["mol"] == None: productos[x]["mol"] = listasa[listaCompuestos.index(x)]['moles']
            if productos[x]["gr"] == None: productos[x]["gr"]  = listasa[listaCompuestos.index(x)]['grams']
